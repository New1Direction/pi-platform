...
from pi_micro_agents.pi_automated_rotation_engine import RotationInput, PiAutomatedRotationEngine
from pi_micro_agents.pi_llm_output_sanitizer import LLMOutputSanitizerInput, PiLLMOutputSanitizer
from pi_micro_agents.pi_data_flow_privacy_mapper import PrivacyMapperInput, PiDataFlowPrivacyMapper
from pi_micro_agents.pi_sensitive_data_scanner import SensitiveDataInput, PiSensitiveDataScanner
...
from pi_micro_agents.pi_structured_logging_enforcer import StructuredLoggingInput, PiStructuredLoggingEnforcer
...
def test_container_escape_detector_consensus():
    ...
    orchestrator = PiOrchestrator()
    input_envelope = ContainerEscapeInput(
        file_path="pod.yaml",
...
def test_hardcoded_secret_detector_consensus():
    ...
    orchestrator = PiOrchestrator()
    input_envelope = HardcodedSecretInput(
        file_path="app.py",
        file_content="password = '123'"
    )
...
def test_automated_rotation_engine_consensus():
    ...
    orchestrator = PiOrchestrator()
    input_envelope = RotationInput(
        credential_type="API_KEY",
        target_identifier="aws_key"
    )
    
    mock_runs = [
        {"is_secure": True, "rotation_completed": True, "rotation_details": {"aws_key": "rotated"}, "status": "COMPLETED"},
        {"is_secure": True, "rotation_completed": True, "rotation_details": {"aws_key": "rotated"}, "status": "COMPLETED"},
        {"is_secure": True, "rotation_completed": True, "rotation_details": {"aws_key": "rotated"}, "status": "COMPLETED"}
    ]
...
def test_llm_output_sanitizer_consensus():
    ...
    orchestrator = PiOrchestrator()
    input_envelope = LLMOutputSanitizerInput(
        raw_output="Hello user",
        system_prompt_reference=""
    )
    
    mock_runs = [
        {"is_secure": True, "sanitized_output": "Hello user", "risk_score": 0.0, "detected_leaks": [], "status": "CLEAN"},
        {"is_secure": True, "sanitized_output": "Hello user", "risk_score": 0.0, "detected_leaks": [], "status": "CLEAN"},
        {"is_secure": True, "sanitized_output": "Hello user", "risk_score": 0.0, "detected_leaks": [], "status": "CLEAN"}
    ]
...
def test_data_flow_privacy_mapper_consensus():
    ...
    mock_runs = [
        {"is_secure": False, "unsecured_flows": ["user_db -> untrusted_console"], "risk_score": 80.0, "status": "COMPROMISED"},
        {"is_secure": False, "unsecured_flows": ["user_db -> untrusted_console"], "risk_score": 80.0, "status": "COMPROMISED"},
        {"is_secure": False, "unsecured_flows": ["user_db -> untrusted_console"], "risk_score": 80.0, "status": "COMPROMISED"}
    ]
...
def test_sensitive_data_scanner_consensus():
    ...
    orchestrator = PiOrchestrator()
    input_envelope = SensitiveDataInput(
        data_label="user_profile",
        text_content="ssn 123-456-7890"
    )
...
def test_automated_anonymizer_consensus():
    ...
    orchestrator = PiOrchestrator()
    input_envelope = AnonymizerInput(
        raw_payload="email abc@test.com"
    )
    
    mock_runs = [
        {"is_secure": True, "anonymized_payload": "email ******@test.com", "fields_scrubbed_count": 1, "status": "SCRUBBED"},
        {"is_secure": True, "anonymized_payload": "email ******@test.com", "fields_scrubbed_count": 1, "status": "SCRUBBED"},
        {"is_secure": True, "anonymized_payload": "email ******@test.com", "fields_scrubbed_count": 1, "status": "SCRUBBED"}
    ]
...
def test_sensitive_log_leak_sentry_consensus():
    ...
    orchestrator = PiOrchestrator()
    input_envelope = LogLeakInput(
        log_file_path="/var/log/app.log",
        log_content="password leaked!"
    )
...
def test_structured_logging_enforcer_consensus():
    ...
    orchestrator = PiOrchestrator()
    input_envelope = StructuredLoggingInput(
        file_path="src/main.py",
        code_content="print('unstructured')"
    )
    
    mock_runs = [
        {"is_secure": False, "unstructured_statements": ["Line 1: print used"], "compliance_score": 85.0, "status": "NON_COMPLIANT"},
        {"is_secure": False, "unstructured_statements": ["Line 1: print used"], "compliance_score": 85.0, "status": "NON_COMPLIANT"},
        {"is_secure": False, "unstructured_statements": ["Line 1: print used"], "compliance_score": 85.0, "status": "NON_COMPLIANT"}
    ]
...
def test_consensus_split_vote_handling():
    ...
    mock_runs = [
        ...
        {"is_secure": False, "unstructured_statements": ["print used"], "compliance_score": 85.0, "status": "NON_COMPLIANT"},
        {"is_secure": True, "unstructured_statements": [], "compliance_score": 100.0, "status": "COMPLIANT"}
    ]
