...
try:
    from needle import NeedleInferenceEngine, NeedleConfig
...
class NeedleConfig:
    def __init__(self, model_path: str, quantization: str = "int4_group32", context_length: int = 8192, device: str = "cpu"):
