...
class ReadOnlyReentrancyOutput(BaseModel):
    ...
    flagged_findings: List[str] = Field(default_factory=list, description="Detailed reentrancy and view-function safety findings")
    risk_score: float = Field(..., description="Risk score from 0.0 to 100.0")
    status: str = Field(..., description="Status classification (PASSED, WARN_READONLY_REENTRANCY, REJECTED_READONLY_REENTRANCY)")
